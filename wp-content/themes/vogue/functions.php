 ...
 * @package Vogue
 */
define( 'VOGUE_THEME_VERSION' , '1.4.43' );
...
function vogue_scripts() {
	...
	wp_enqueue_style( 'vogue-font-awesome', get_template_directory_uri().'/includes/font-awesome/css/all.min.css', array(), '5.9.0' );
...
function vogue_load_admin_script( $hook ) {
	...
	wp_enqueue_script( 'vogue-admin-js', get_template_directory_uri() . '/upgrade/js/admin.js', array('jquery'), VOGUE_THEME_VERSION );
}
...
function vogue_add_license_notice() {
	...
	if ( !get_user_meta( $vogue_user_id, 'vogue_flash_notice_ignore' ) ) : ?>
		<div class="notice notice-info vogue-admin-notice vogue-notice-add">
			<h4>
				<?php esc_html_e( 'Thank you for trying out Vogue!', 'vogue' ); ?> -
				<span>
					<?php
					/* translators: %s: 'Recommended Resources' */
					printf( esc_html__( 'Premium is currently on a %1$s for only $19', 'vogue' ), wp_kses( __( '<a href="https://kairaweb.com/go/purchase-vogue/" target="_blank">35% flash sale</a>', 'vogue' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ) );
					?>
				</span>
			</h4>
			<p><?php esc_html_e( 'We\'re here to help... Please read through our help notes below on getting started with Vogue:', 'vogue' ); ?></p>
			<div class="vogue-admin-notice-blocks">
				<div class="vogue-admin-notice-block">
					<h5><?php esc_html_e( 'About Vogue:', 'vogue' ); ?></h5>
					<p>
						<?php esc_html_e( 'Vogue is a widely used and much loved WordPress theme which gives you lots of different customization settings... so you can easily change the look of your site any time.', 'vogue' ); ?>
					</p>
					<p>
						<?php
						/* translators: %s: 'Recommended Resources' */
						printf( esc_html__( 'Read through our %1$s and %2$s and we\'ll help you build a professional website easily.', 'vogue' ), wp_kses( __( '<a href="https://kairaweb.com/go/vogue-recommended-resources/" target="_blank">Recommended Resources</a>', 'vogue' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ), wp_kses( __( '<a href="https://kairaweb.com/documentation/" target="_blank">Kaira Documentation</a>', 'vogue' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ) );
						?>
					</p>
					<a href="<?php echo esc_url( admin_url( 'themes.php?page=theme_info' ) ) ?>" class="vogue-admin-notice-btn">
						<?php esc_html_e( 'Read More About Vogue', 'vogue' ); ?>
					</a>
				</div>
				<div class="vogue-admin-notice-block">
					<h5><?php esc_html_e( 'Using Vogue:', 'vogue' ); ?></h5>
					<p>
						<?php
						/* translators: %s: 'set up your site in WordPress' */
						printf( esc_html__( 'See our recommended %1$s and how to get ready before you start building your website after you\'ve %2$s.', 'vogue' ), wp_kses( __( '<a href="https://kairaweb.com/documentation/our-recommended-wordpress-basic-setup/" target="_blank">WordPress basic setup</a>', 'vogue' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ), wp_kses( __( '<a href="https://kairaweb.com/wordpress-hosting/" target="_blank">setup WordPress Hosting</a>', 'vogue' ), array( 'a' => array( 'href' => array(), 'target' => array() ) ) ) );
						?>
					</p>
					<a href="<?php echo esc_url( 'https://kairaweb.com/go/vogue-recommended-resources/' ) ?>" class="vogue-admin-notice-btn-in" target="_blank">
						<?php esc_html_e( 'Recommended Resources', 'vogue' ); ?>
					</a>
					<p>
						<?php esc_html_e( 'We\'ve neatly built most of the Vogue settings into the WordPress Customizer so you can see all your changes happen as you built your site.', 'vogue' ); ?>
					</p>
					<a href="<?php echo esc_url( admin_url( 'customize.php' ) ) ?>" class="vogue-admin-notice-btn-grey">
						<?php esc_html_e( 'Start Customizing Your Website', 'vogue' ); ?>
					</a>
				</div>
				<div class="vogue-admin-notice-block vogue-nomargin">
					<h5><?php esc_html_e( 'Popular FAQ\'s:', 'vogue' ); ?></h5>
					<p>
					<?php esc_html_e( 'See our list of popular help links for building your website and/or any issues you may have.', 'vogue' ); ?>
					</p>
					<ul>
						<li>
							<a href="https://kairaweb.com/documentation/setting-up-the-default-slider/" target="_blank"><?php esc_html_e( 'Setup the Vogue default slider', 'vogue' ); ?></a>
						</li>
						<li>
							<a href="https://kairaweb.com/documentation/adding-custom-css-to-wordpress/" target="_blank"><?php esc_html_e( 'Adding Custom CSS to WordPress', 'vogue' ); ?></a>
						</li>
						<li>
							<a href="https://kairaweb.com/documentation/mobile-menu-not-working/" target="_blank"><?php esc_html_e( 'Mobile Menu is not working', 'vogue' ); ?></a>
						</li>
						<li>
							<a href="https://kairaweb.com/go/what-vogue-premium-offers/" target="_blank"><?php esc_html_e( 'What does Vogue Premium offer extra', 'vogue' ); ?></a>
						</li>
					</ul>
					<a href="<?php echo esc_url( 'https://kairaweb.com/documentation/' ) ?>" class="vogue-admin-notice-btn-grey" target="_blank">
						<?php esc_html_e( 'See More Documentation', 'vogue' ); ?>
					</a>
				</div>
			</div>
...
function vogue_add_license_notice_ignore() {
    ...
    if ( isset( $_GET['vogue_add_license_notice_ignore'] ) ) {
		update_user_meta( $vogue_user_id, 'vogue_flash_notice_ignore', true );
    }
}
