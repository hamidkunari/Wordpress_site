            ...
            <div class="home-slider">
                ...
                <div class="home-slider-block" style="background-image: url(<?php echo get_stylesheet_directory_uri() ?>/images/demo/slider_default_01.jpg);">
                    ...
                    <div class="home-slider-block-inner">
                        <div class="home-slider-block-bg">
                            <h3>
                                <?php esc_html_e( 'Highly Customizable', 'vogue' ); ?>
                            </h3>
                            <p><?php esc_html_e( 'Integrated with WooCommerce, SiteOrigin\'s Page Builder, Contact Form 7 and more...', 'vogue' ); ?></p>
                        </div>
                    </div>
                ...
                <div class="home-slider-block" style="background-image: url(<?php echo get_stylesheet_directory_uri() ?>/images/demo/slider_default_02.jpg);">
                    ...
                    <div class="home-slider-block-inner">
                        <div class="home-slider-block-bg">
                            <h3>
                                <?php esc_html_e( 'Beautiful online store', 'vogue' ); ?>
                            </h3>
                            <p><?php esc_html_e( 'Easily create your online presence with our Vogue WordPress theme', 'vogue' ); ?></p>
                        </div>
                    </div>
