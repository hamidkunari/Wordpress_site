...
function customizer_library_vogue_options() {
    ...
    $options['vogue-note-layout'] = array(
        ...
        'section' => $section,
        'type'    => 'note',
        'description' => __( '<b>Premium Extra Features:</b><br />- Settings to add "Site Built By" backlinks to the footer<br />- Site Boxed / Full Width layouts<br />- Set custom website container width<br />- Set page sidebar custom width<br />- Remove all Page Titles<br />- Page Featured Image displayed as full width banner<br />- Set WooCommerce Shop, Archives & Product pages to Left Sidebar<br />- Set WooCommerce Shop, Archives & Product pages to Full Width<br />- Remove WooCommerce Product borders<br />- Set Shop products per page<br />- Set Shop products per row<br />- Remove WooCommerce Product Image Zoom and/or LightBox', 'vogue' )
    );
    ...
    $options['vogue-note-slider'] = array(
        ...
        'section' => $section,
        'type'    => 'note',
        'description' => __( '<b>Premium Extra Features:</b><br />- Set each slide to have custom url link<br />- Set Slider to use actual image size<br />- Change slider size - Small / Medium / Large<br />- Scroll Duration<br />- Remove slider title/text<br />- Link slide To post<br />- Stop auto scroll<br /><br />- Extra Slider color settings', 'vogue' )
    );
    ...
    $options['vogue-note-footer'] = array(
        ...
        'section' => $section,
        'type'    => 'note',
        'description' => __( '<b>Premium Extra Features:</b><br />- Change Social Footer Styling - plain/round/square/rounded/circled+<br />- Offers 5 footer layouts<br />- Advanced custom footer layout, select columns & manually adjust column widths<br />- Remove/Edit Kaira attribution text<br />- Settings to add "Site Built By" backlinks to the footer', 'vogue' )
    );
    ...
    $options['vogue-nav-font-size'] = array(
        'id' => 'vogue-nav-font-size',
        'label'   => __( 'Navigation Font Size', 'vogue' ),
        'section' => $section,
        'type'    => 'range',
        'input_attrs' => array(
            'min'   => 11,
